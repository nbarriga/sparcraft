...
bool TTEntry::hashMatches(const HashType & hash2) const
{
	return hash2 == _hash2;
}

bool TTEntry::isValid() const
{
...
const TTEntry & TranspositionTable::get(const size_t & hash) const
{
 ...
 size_t TranspositionTable::getSaveIndex(const size_t & index, const HashType & hash2, const size_t & depth) const
{
...
const size_t & TranspositionTable::numLookups()		const { return lookups; }
 ...
 size_t TranspositionTable::getUsage() const
{
	size_t sum(0);
